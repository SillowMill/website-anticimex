...
const CONFIG = {
  // Business identity
  name: "Anticimex België",
  tagline: "90 jaar innovatie in ongediertebestrijding.",
  logoUrl: "/logo.png",
  logoAlt: "Anticimex België Logo",
  logoClassName: "h-8 md:h-10",

  // Contact
  phone: "0800 54 344",
  phoneLink: "tel:+3280054344",
  email: "info@anticimex.be",
  whatsapp: "https://api.whatsapp.com/send?phone=3280054344",
  ...
  // About text
  aboutText: "Anticimex is al 90 jaar dé leider in ongediertebestrijding in België. Onze technici, biologen en experts bieden definitieve oplossingen voor elk ongedierteprobleem in zowel residentiële als commerciële omgevingen. Met CEPA-, VCA- en ISO-certificeringen garanderen wij de hoogste kwaliteitsstandaarden.",
  ...
  // Social links
  social: {
    facebook: "https://www.facebook.com/AnticimexBE/",
    instagram: "https://www.instagram.com/anticimex_be/",
    linkedin: "https://www.linkedin.com/company/anticimex-nv/",
  },
};
